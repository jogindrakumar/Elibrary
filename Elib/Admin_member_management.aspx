<%@ Page Title="" Language="C#" MasterPageFile="~/Site1.Master" AutoEventWireup="true" CodeBehind="Admin_member_management.aspx.cs" Inherits="Elib.Admin_member_management" %>
            ...
            <div class="card">
               <div class="card-body">
                  ...
                  <div class="row">
                     <div class="col">
                        <center>
                           <img class="page-img" src="image/generaluser.png" />
                        </center>
                     </div>
                  </div>
                  <div class="row">
